...
void JY901_read_acc(struct SAcc *std_acc)
{
	uint8_t buf[6];
	memset(buf, 0, 6);
	I2C_ReadMem(I2C_JY901, JY901_SLAVE_ADDR, AX, 1, buf, 6, I2C_DEFAULT_TIME_OUT);
...
{
	uint8_t buf[6];
	I2C_ReadMem(I2C_JY901, JY901_SLAVE_ADDR, GX, 1, buf, 6, I2C_DEFAULT_TIME_OUT);
...
{
	uint8_t buf[6];
	I2C_ReadMem(I2C_JY901, JY901_SLAVE_ADDR, HX, 1, buf, 6, I2C_DEFAULT_TIME_OUT);
...
{
	uint8_t buf[6];
	I2C_ReadMem(I2C_JY901, JY901_SLAVE_ADDR, Roll, 1, buf, 6, I2C_DEFAULT_TIME_OUT);
...
{
	uint8_t buf[8];
	I2C_ReadMem(I2C_JY901, JY901_SLAVE_ADDR, Q0, 1, buf, 8, I2C_DEFAULT_TIME_OUT);
